...
snv_recurrence = pd.read_excel("C:/Users/Jacob-Lab/OneDrive - g.ntu.edu.tw/python/Deafness/SNV_recurrence/VaraintBasedArray.xlsx", index_col="Idx")
sv_recurrence = pd.read_excel("C:/Users/Jacob-Lab/OneDrive - g.ntu.edu.tw/python\Deafness/SV_recurrence/VaraintBasedArray.xlsx", index_col="Idx")
  
# add snv ACMG_ranking info (from TaiGenomics)
ranking_info = pd.read_table("union_of_ranking.txt")
...
snv = {'Chr':snv_recurrence["Chr"],
       ...
       'Variant_type':"snv",
       'MDD0026':snv_recurrence["MDD0026_hg38_annotation"],
       'MDD0027':snv_recurrence["MDD0027_hg38_annotation"],
       'MDD0131':snv_recurrence["MDD0131_hg38_annotation"],
       'MDD0132':snv_recurrence["MDD0132_hg38_annotation"],
       'MDD0188':snv_recurrence["MDD0188_hg38_annotation"],
...
sv = {'Chr':sv_recurrence["SV chrom"],
       ...
       'MDD0026':sv_recurrence["MDD0026"],
       'MDD0027':sv_recurrence["MDD0027"],
       'MDD0131':sv_recurrence["MDD0131"],
       'MDD0132':sv_recurrence["MDD0132"],
       'MDD0188':sv_recurrence["MDD0188"],
...
candidate = pd.read_table("deafness_gene_checklist.txt")
...
recurrence_table.to_excel("recurrence_table.xlsx", index= False)
